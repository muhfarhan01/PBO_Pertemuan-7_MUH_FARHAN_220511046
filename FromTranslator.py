...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Hasil filipino:', foreground='green').grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil jepang:', foreground='red').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil vietnamese:', foreground='purple').grid(row=6, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil hungarian:', foreground='purple').grid(row=8, column=0,
            sticky=W, padx=5, pady=5)
        ...
        self.txtHasil1 = Entry(mainFrame, width=50, bg='lightyellow') 
    ...
    def onTranslate(self):
        ...
        hasil2 = penterjemah.translate(self.txtSumber.get(), src='id', dest='ja') 
        hasil3 = penterjemah.translate(self.txtSumber.get(), src='id', dest='vi') 
        hasil4 = penterjemah.translate(self.txtSumber.get(), src='id', dest='hu') 
